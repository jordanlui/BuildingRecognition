function g = burnsedgevote(lsr1,lsr2,M,N)
...
% Important Variables
tic
numbin = length(lsr1); % This # of bins should be same for both LSR1 and LSR2
...
% Format will be [pixel# region1# region2# region1size region2size]
